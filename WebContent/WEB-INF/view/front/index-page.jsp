...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
		...
		<!-- Ovde su vam u linkovima falili ${pageContext.request.contextPath}/ na svim linkovima za css i js. Znaci morate proci kroz sve stranice i gde god nije ovaj http link, setovati ovako kao sto sam ja -->
		<!-- druga stvar. nisu svi fajlovi dobro prekopirani u resurse. pogledajte da li ste dobro prekopirali i da li trebate resurse da razdvojite na fron i back.  -->
		<!-- evo ovaj recimo fajl ispod hajde da vidimo da liima u resursima  bootstrap nije u resursima. znaci niste sve fajlove dobro prekopirali-->
		<!-- hajde proverite to u lekciji u kojoj smo dodavali css i js fajlove u resursima -->
            ...
            <section class="preciousSense">
                ...
                <div class="text-center">
                    ...
                    <c:forEach var="i" begin="0" end="${categories.size()-1 }">
                      <c:if test="${i==0 }">
                     <li role="presentation" class="active"><a href="#${categores[i].name}"   data-toggle="tab">${categories[i].name}</a></li>
                        </c:if>
                        <c:if test="${i>0 }">
                     <li role="presentation"><a href="#${categores[i].name}"   data-toggle="tab">${categories[i].name}</a></li>
                        </c:if>
