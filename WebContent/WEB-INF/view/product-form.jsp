					...
					<div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <form:input type="text" class="form-control" placeholder="Enter recipe name" path="recipe.name"/>
                         <form:errors path="recipe.name" cssClass="text-danger"></form:errors>
                      </div>
                      <div class="form-group">
                        <label>Recipe description</label>
                        <form:textarea class="form-control" placeholder="Enter recipe description" path="recipe.description"/>
                         <form:errors path="recipe.description" cssClass="text-danger"></form:errors>
                      ...
                      <div class="form-group">
                        <label>Tags</label>
                        <div>
                         <form:select path="tags" items="${tagList}" itemLabel="name" itemValue="id" multiple="true" class="custom-select"/>
                        </div>
                      </div>
